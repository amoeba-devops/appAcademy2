...
export const router = createBrowserRouter([
  ...
  // ── Admin console (requires admin JWT) ──────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'std/tpi', element: <StdListPage key="tpi" fixedSite="TPI" /> },
      { path: 'std/trinity', element: <StdListPage key="trinity" fixedSite="TRINITY" /> },
      { path: 'std/santa-croce', element: <StdListPage key="santa" fixedSite="SANTACROCE" /> },
      { path: 'std/withdrawn', element: <StdListPage key="withdrawn" withdrawn /> },
