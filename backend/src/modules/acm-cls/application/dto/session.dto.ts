...
export const FBK_STATUSES = [
  'DRAFT',
  'SUBMITTED',
  'DELIVERED_TO_PARENT',
] as const;
export const MKP_STATUSES = [
  'PROPOSED',
  'APPROVED',
  'COMPLETED',
  'CARRIED_OVER',
...
export class CreateSessionDto {
  ...
  @ApiPropertyOptional({ enum: SES_MODES })
  @IsOptional()
  @IsEnum(SES_MODES)
...
export class CancelSessionDto {
  @ApiProperty({ enum: SES_CANCEL_REASONS })
  @IsEnum(SES_CANCEL_REASONS)
...
export class ConfirmSettlementDto {
  @ApiPropertyOptional({
    description: 'Override withholding rate (e.g. 0 for 사업자)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
