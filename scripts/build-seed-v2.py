...
Reads docs/reference/TPI 학생 정보.xlsx and produces:
  ...
  sql/060-seed-tpi-students-v2.sql     — executable seed
...
SQL_OUT = ROOT / "sql/060-seed-tpi-students-v2.sql"
...
def emit_sql(sheet4, sheet2):
    ...
    P("-- Depends: 010-academy-management-schema.sql, 020-seed-dev.sql,")
    P("--          040-migration-student-import-1.0.0.sql, 050-seed-tpi-students.sql")
    P("-- =============================================================")
    P("")
    P("SET NAMES utf8mb4;")
